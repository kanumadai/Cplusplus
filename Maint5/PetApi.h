...
//=========================维护信箱=======================================
int WINAPI OpenShmMaintain();//连接维护信箱
int WINAPI CloseShmMaintain();//断开维护信箱
int WINAPI WriteCommandMaintain(int, BYTE*);//写维护命令
int WINAPI ReadResultMaintain(BYTE*);//读维护结果
//========================================================================
